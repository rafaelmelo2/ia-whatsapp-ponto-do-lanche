// Template do system prompt (era promptBase.md lido do disco via fs — saiu do core
// como módulo TS pra manter o core sem I/O). Placeholders {{...}} preenchidos pelo
// PromptBuilder a partir da config do tenant (banco).
export const PROMPT_BASE = `Você é o Atendente Virtual Oficial da Hamburgueria {{store.name}}.
